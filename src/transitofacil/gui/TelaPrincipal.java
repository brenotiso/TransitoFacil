...
public class TelaPrincipal extends JFrame {
    ...
    private void construirTela() {
        ...
        JLabel lbTitulo = new JLabel("Aprendizado de Trânsito");
        ...
        adicionarComponente(btPlacas, GridBagConstraints.WEST, GridBagConstraints.NONE, 1, 0, 1, 1);
        adicionarComponente(btTransitoGeral, GridBagConstraints.WEST, GridBagConstraints.NONE, 2, 0, 1, 1);
        adicionarComponente(btSimuladoPlacas, GridBagConstraints.WEST, GridBagConstraints.NONE, 3, 0, 1, 1);
        adicionarComponente(btSimuladoTransitoGeral, GridBagConstraints.WEST, GridBagConstraints.NONE, 4, 0, 1, 1);
        adicionarComponente(lbGrupo1, GridBagConstraints.CENTER, GridBagConstraints.NONE, 5, 0, 1, 1);
        adicionarComponente(lbGrupo2, GridBagConstraints.CENTER, GridBagConstraints.NONE, 6, 0, 1, 1);
        adicionarComponente(lbGrupo3, GridBagConstraints.CENTER, GridBagConstraints.NONE, 7, 0, 1, 1);
